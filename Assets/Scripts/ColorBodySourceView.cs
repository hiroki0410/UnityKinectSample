...
public class ColorBodySourceView : MonoBehaviour 
{
	...
	public Camera convert_camera_;

	private Kinect.CoordinateMapper coordinate_mapper_;

	private int kKinectWidth  = 1920;
	private int kKinectHeight = 1080;
    ...
    void Update () 
    {
		...
		{ 
			coordinate_mapper_ = _BodyManager.Sensor.CoordinateMapper;
		}	
    }
